...
{//remember to instantiate new objects such that it follows the row logic
	...
	void Populate()
	{
						 ...
						 + "/Maps/"))
		{
			...
			if (files.GetLength(0) == 0) // I should put this above and do else to be efficent... but I wrote this already... and it really DOES NOT MATTER
			{
