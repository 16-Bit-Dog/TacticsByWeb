...
public class SelectMapLocalToDelete : MonoBehaviour
{
	static SelectMapLocalToDelete Ml;
    ...
    public void DeleteMapDataLocalAfterSelect()
    {
        File.Delete(StaticDataMapMaker.controlObj.LoadMapDatPath);
	...
	void LoadToEdit(int i)
	{
        ...
        StaticDataMapMaker.controlObj.LoadShowOffToDeleteLocal();
